...
(function () {
  ...
  function loadMessage() {
    ...
    box.textContent = "[YCY] 电击器联动工具 v0.1.0 载入！ 使用 /lt help 查看说明";
    localNode(box, 20000);
  }
  ...
  async function getSign() {
    ...
    if (!parsed) throw new Error("没有有效 connect_code。请使用 /lt code UID Token");
  ...
  function helpText() {
    ...
    return [
      ...
      "/lt on / off：启用或关闭联动",
      "/lt consent on / off：本次会话授权",
      "/lt login：登录 Tencent IM",
      "/lt sync：同步角色身上的玩具数据",
      "/lt test hit|shock|touch：发送测试事件",
      "/lt stop：紧急停止",
      "兼容命令前缀：/lt、/ycy",
